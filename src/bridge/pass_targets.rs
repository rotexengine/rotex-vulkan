...
pub(super) struct PassTargetKey {
    ...
    uses_depth: bool,
    pub(super) target_role: TargetPassRole,
}
...
pub(super) fn color_final_layout(target: PassColorTarget, role: TargetPassRole) -> vk::ImageLayout {
    match (target, role) {
